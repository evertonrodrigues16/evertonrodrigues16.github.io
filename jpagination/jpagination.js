...
function activate(btnId){
    ...
    //btnId = 'btn' + numIdActive;
    var dom = document.getElementsByClassName("page-item");
    
    for(var i=0;i<dom.length;i++)
    {
        dom[i].className = 'page-item';
    }
...
function generate(divId, allItems, perPage){
    ...
    for (var i=0; i<numberPages; i++)
    {
        ...
        var text = '<li id="btn' + (i+1) + '" class="page-item'+act+'"><a class="page-link" href="#nossos-momentos" onclick="splitItems('+ arg +', ' + perPage + ', ' + (i+1) + ')">' + (i+1) + '<span class="sr-only">(current)</span></a></li>';
        dom.innerHTML += text;
    }
    var header = '<li id="btnPrevious" class="disabled"><a class="page-link" href="#nossos-momentos" onclick="splitItems(-2, ' + perPage + ', \'previous\')" aria-label="Previous"><span aria-hidden="true">&laquo;</span></a></li>';
    
    var footer = '<li id="btnNext"><a class="page-link" href="#nossos-momentos" onclick="splitItems(-1, ' + perPage + ', \'next\')" aria-label="Next"><span aria-hidden="true">&raquo;</span></a></li>';
